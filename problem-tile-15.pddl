(define (problem puzzle-15-tile-hard)
  ...
  (:init
    ...
    ; Inverso total pero con 1 y 2 cambiados para ser soluble
    ...
    (at t3 p4-1)  (at t1 p4-2)  (at t2 p4-3)  (empty p4-4)
  )
  (:goal (and
    ; OBJETIVO: 1 2 3 ... 15 _
    ...
    (at t13 p4-1) (at t14 p4-2) (at t15 p4-3) (empty p4-4)
  ))
)
